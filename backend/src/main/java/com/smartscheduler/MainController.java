...
public class MainController {
    ...
    public String seedData() {
        ...
        User p3 = new User();
        p3.setFullName("Dr. Ramesh");
        p3.setUsername("ramesh");
        p3.setPassword("123");
        p3.setRole("PROFESSOR");
        p3.setDepartment("AI/ML");
        p3.setMobile("9988776655");
        userRepository.save(p3);

        User p4 = new User();
        p4.setFullName("Prof. Sneha");
        p4.setUsername("sneha");
        p4.setPassword("123");
        p4.setRole("PROFESSOR");
        p4.setDepartment("AI");
        p4.setMobile("9876543210");
        ...
        for (int i = 0; i < days.length; i++) {
            ...
            // New default subjects and teachers:
            Schedule sD = new Schedule();
            sD.setProfessorName("Dr. Ramesh");
            sD.setSubject("ML");
            sD.setDay(d);
            sD.setTime("03:00 PM");
            sD.setGroupName("Group A");
            scheduleRepository.save(sD);

            if (i % 2 == 0) {
                Schedule sE = new Schedule();
                sE.setProfessorName("Prof. Sneha");
                sE.setSubject("AI");
                sE.setDay(d);
                sE.setTime("04:00 PM");
                sE.setGroupName("Group B");
    ...
    public Map<String, String> forgotPassword(@RequestBody Map<String, String> data) {
        ...
        if (foundUser.isPresent()) {
            User userObj = foundUser.get();
            String storedMobile = userObj.getMobile();
            if (storedMobile != null && storedMobile.trim().equals(mobile != null ? mobile.trim() : "")) {
                userObj.setPassword(newPassword);
                userRepository.save(userObj);
                response.put("status", "success");
        ...
        response.put("status", "fail");
        response.put("message", "❌ Username or registered mobile number mismatch!");
        return response;
    }
}
